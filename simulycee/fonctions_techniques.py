...
def coordonneesCoupage(parking,coordsRoute,sensAllongement):
    ...
    """
    numRouteChoisicc1 = randint(0,len(coordsRoute[(LARGEUR_PARKING//2,0)])-1) # on choisit le 1er bloc de route
    (iCoup1,jCoup1) = np.array(list(coordsRoute[(LARGEUR_PARKING//2,0)]))[numRouteChoisicc1]
    """
    ...
    (iCoup2,jCoup2) = np.array(list(coordsRoute[(LARGEUR_PARKING//2,0)]))[numRouteChoisicc2]
    """
